<template>
  <q-page>
    <div
      v-if="Object.keys(tileMaps).length"
      ...
      <div class="munch-index">
        <div class="munch-index__left">
          ...
          <div class="munch-index__left__toggle">
            <div v-if="showSprite">
              <button
                class="no-style munch-index__left__toggle munch-index__left__toggle--show"
                @click="toggleSprite()"
              >
            ...
            <button
              v-else
              class="no-style munch-index__left__toggle"
              @click="toggleSprite()"
            >
              <img src="./mini.png">
            </button>
